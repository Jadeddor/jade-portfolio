...
const EXP = [
  ...
  { date:'May 2020–May 2021', title:'Help Desk Intern', org:'Dulaney High School', desc:'Troubleshot hardware, network, and device issues. Reimaged student devices after a ransomware incident, my first experience with security response at scale.' },
];
const SKILLS = [
  {w:'Python',l:'l4'},{w:'Agentic AI',l:'l4'},{w:'React',l:'l3'},{w:'AI/LLMs',l:'l4'},{w:'TypeScript',l:'l2'},
  {w:'Computer Vision',l:'l3'},{w:'Workflow Automation',l:'l3'},{w:'FastAPI',l:'l2'},{w:'Vue.js',l:'l3'},{w:'SQL',l:'l2'},
    ...
    <main>
      ...
      <div className="definition-card rev">
        ...
        <p className="def-body">
          An industrious engineer who builds, breaks, and automates whatever's in front of her.
          Powered by curiosity, coffee, and a relentless drive to figure things out.
        </p>
      ...
      <section className="about-grid rev">
        ...
        <div className="about-text-col">
          <div className="about-aside-photo">
            <img src={falls} alt="A waterfall along one of my hiking trails" loading="lazy" />
            <span>trail day</span>
          </div>
          <p className="about-quote">
            "I love technology, and I build things with it that actually work."
          </p>
          ...
          <p>I graduated from UMBC in December 2025 with a B.S. in Computer Science (AI/ML track) and a certification in User Experience & Web Development. Currently working as a software engineer while shipping side projects in agentic AI and workflow automation.</p>
          <p>My love for programming started at 15, in a 10th-grade CS class, where I built a small game inspired by one of my favorite anime. That spark never left. Designing and illustrating became hobbies during quarantine, and music has always been playing in the background while I work.</p>
          <p>Usually with a cup of coffee nearby.</p>
          <div className="about-chips">
            {['Maryland, USA','UMBC CS Grad','AI/ML Focus','Guitar','Coffee','Nature','Night Coder'].map(c => (
