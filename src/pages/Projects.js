...
const PROJECTS = [
  { id:1, n:'01', title:'Simple Stickers', sub:'Multi-Model Instance Segmentation', desc:'Full-stack computer vision platform comparing YOLOv12, Mask2Former, RT-DETR + SAM2, and open-vocabulary pipelines side-by-side. Unified API for benchmarking accuracy, mask quality, and inference latency.', tech:['FastAPI','React','Docker','Python','OpenCV'], tags:['AI/ML','Computer Vision','Full-Stack'], github:'https://github.com/adams-x0/cv_project', live:null, status:'In Progress' },
  { id:2, n:'02', title:'CSEE Triage Bot', sub:'Agentic Workflow Automation', desc:'An agentic workflow that classifies, routes, and escalates support requests automatically using Groq LLM inference and Atlassian APIs, with structured logging and persistent storage.', tech:['Python','TypeScript','SQL','REST APIs','Groq LLM'], tags:['AI/ML','Full-Stack','Automation'], github:'https://github.com/Jadeddor/CSEE-Triage-SWE', live:null, status:'In Progress' },
  { id:3, n:'03', title:'Portfolio Site', sub:'This website, v3', desc:'Designed and built from scratch in React. Custom guitar pick cursor, parallax hero, scroll reveal animations, splash screen, and fully responsive across all breakpoints. Zero animation libraries, just pure CSS.', tech:['React','CSS','React Router'], tags:['Frontend','UX/Design'], github:null, live:null, status:'Live' },
  { id:4, n:'04', title:'Next Build', sub:'Something new is brewing', desc:'Another project is already taking shape. Follow on GitHub or reach out if you want to collaborate on something interesting.', tech:[], tags:['Coming Soon'], github:null, live:null, status:'Upcoming' },
];

const FILTERS = ['All','AI/ML','Automation','Full-Stack','Frontend','UX/Design'];
  ...
  return (
    <main>
      <section className="proj-banner">
        ...
        <p className="fu d2">Full-stack, AI/ML, and agentic workflows, built end-to-end, solo.</p>
      </section>
